...
//      ShowForm(TfrmBrowseBarang).Show;
      ...
      frmFP.FLAGEDIT := True;
      frmFP.edtnOMOR.Text := frmMenu.KDCABANG+'-SO'+copy(CDSMaster.FieldByname('Nomor').AsString,6,Length(CDSMaster.FieldByname('Nomor').AsString));
      frmFP.loaddataall(frmMenu.KDCABANG+'-SO'+copy(CDSMaster.FieldByname('Nomor').AsString,6,Length(CDSMaster.FieldByname('Nomor').AsString)));
   end;
