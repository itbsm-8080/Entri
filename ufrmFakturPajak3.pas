...
begin
  ...
  s := ' SELECT 0,fp_tanggal,"Normal","04", '
    + '" " KeteranganTambahan," " DokumenPendukung,fp_nomor," " CapFasilitas,CONCAT("0",'+fnpwp+',"000000"),cus_npwp,"TIN","IDN","-",cus_namanpwp,cus_alamatnpwp,"-",concat(cus_npwp,"000000")'
       ...
       begin
            ...
            while  not Eof do
             begin
                   ...
                   CDS.FieldByName('Referensi').AsString  :=fields[6].asstring;
                   CDS.FieldByName('CapFasilitas').AsString  :=fields[7].asstring;
                   CDS.FieldByName('idtkupenjual').AsString  :=fields[8].asstring;
                   CDS.FieldByName('npwppembeli').AsString  :=stringreplace(StringReplace(fields[9].asstring,'.','',[rfReplaceAll]),'-','',[rfReplaceAll]);
                   CDS.FieldByName('jenisidpembeli').AsString  :=fields[10].asstring;
                   CDS.FieldByName('NegaraPembeli').AsString  :=fields[11].asstring;
                   CDS.FieldByName('nomordokumenpembeli').AsString  :=fields[12].asstring;
                   CDS.FieldByName('namapembeli').AsString  :=fields[13].asstring;
                   CDS.FieldByName('alamatpembeli').AsString  :=fields[14].asstring;
                   CDS.FieldByName('emailpembeli').AsString  :=fields[15].asstring;
                   CDS.FieldByName('idtkupembeli').AsString  :=stringreplace(StringReplace(fields[16].asstring,'.','',[rfReplaceAll]),'-','',[rfReplaceAll]);
